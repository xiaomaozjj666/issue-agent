(function () {
  ...
  const I18N_DEFAULTS = {
    ...
    hero_subtitle: "Reads the thread, verifies the root cause against repository code, generates a patch with regression tests, every conclusion independently reviewed.",
