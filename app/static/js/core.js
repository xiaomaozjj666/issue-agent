(function () {
  ...
  const I18N_DEFAULTS = {
    ...
    hero_subtitle: "It reads the full thread, checks the cause against the repository code, then writes a patch with matching tests. Each report is double-checked before it reaches you.",
