...
_FRONTEND_STRINGS = {
    "zh": {
        ...
        "hero_title": "贴上 Issue 链接",
        "hero_title_accent": "拿到原因和补丁",
        "hero_subtitle": "它会读代码核实原因，报告里带补丁和测试。",
        "hero_step1_label": "01",
        "hero_step1_title": "粘贴链接",
        "hero_step1_desc": "支持公开仓库",
        "hero_step2_label": "02",
        "hero_step2_title": "自动调查",
        "hero_step2_desc": "读代码，核实原因",
        "hero_step3_label": "03",
        "hero_step3_title": "查看报告",
        "hero_step3_desc": "原因、证据、补丁",
        "hero_examples_title": "真实案例",
        "hero_examples_desc": "点击即可开始",
    ...
    "en": {
        ...
        "hero_title": "Paste an issue link",
        "hero_title_accent": "get the cause and a patch",
        "hero_subtitle": "It checks the code, then reports back with a patch and tests.",
        "hero_step1_label": "01",
        "hero_step1_title": "Paste a link",
        "hero_step1_desc": "Public repos supported",
        "hero_step2_label": "02",
        "hero_step2_title": "It investigates",
        "hero_step2_desc": "Reads code, verifies the cause",
        "hero_step3_label": "03",
        "hero_step3_title": "Read the report",
        "hero_step3_desc": "Cause, evidence, patch",
        "hero_examples_title": "Real cases",
        "hero_examples_desc": "Click to start",
        "hero_example_1_repo": "psf/requests",
