...
_FRONTEND_STRINGS = {
    "zh": {
        ...
        "hero_title": "让 Agent 替你调查 Issue",
        "hero_title_accent": "弄清楚问题出在哪，该怎么改",
        "hero_subtitle": (
            "它会读完 issue 里的讨论，到仓库代码里核实原因，再写出补丁和配套测试。"
            "报告出来前还会复核一遍。"
        ),
        "hero_step1_label": "01",
        "hero_step1_title": "粘贴 Issue 链接",
        "hero_step1_desc": "支持公开仓库的 Issue 地址",
        "hero_step2_label": "02",
        "hero_step2_title": "Agent 自动调查",
        "hero_step2_desc": "在仓库代码里核实问题原因",
        "hero_step3_label": "03",
        "hero_step3_title": "查看调查报告",
        "hero_step3_desc": "写清原因，附上证据和补丁",
    ...
    "en": {
        ...
        "hero_title": "Let the agent investigate for you",
        "hero_title_accent": "figure out what broke and how to fix it",
        "hero_subtitle": (
            "It reads the full thread, checks the cause against the repository code, "
            "then writes a patch with matching tests. Each report is double-checked before it reaches you."
        ),
        "hero_step1_label": "01",
        "hero_step1_title": "Paste an Issue URL",
        "hero_step1_desc": "Works with public repository issue URLs",
        "hero_step2_label": "02",
        "hero_step2_title": "Agent investigates",
        "hero_step2_desc": "Checks the cause against real code",
        "hero_step3_label": "03",
        "hero_step3_title": "Read the report",
        "hero_step3_desc": "Explains the cause, with evidence and a patch",
