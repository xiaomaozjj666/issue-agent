...
_FRONTEND_STRINGS = {
    "zh": {
        ...
        "hero_title": "从一条 Issue 链接开始",
        "hero_title_accent": "定位根因，产出修复补丁",
        "hero_subtitle": "读取正文与评论，检索仓库源码验证根因，生成补丁与回归测试，每个结论都经独立审查复核。",
        "hero_step1_label": "01",
        ...
        "hero_step3_desc": "结论前置 · 证据可查 · 修复可执行",
    ...
    "en": {
        ...
        "hero_title": "Start from an issue link",
        "hero_title_accent": "trace the root cause, produce a patch",
        "hero_subtitle": (
            "Reads the thread, verifies the root cause against repository code, "
            "generates a patch with regression tests, every conclusion independently reviewed."
        ),
        "hero_step1_label": "01",
        ...
        "hero_step3_desc": "Conclusion first · traceable evidence · actionable fix",
