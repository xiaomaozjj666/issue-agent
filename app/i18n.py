...
_FRONTEND_STRINGS = {
    "zh": {
        ...
        "hero_title": "不用再翻源码找 bug",
        "hero_title_accent": "拿到能跑的补丁和测试",
        "hero_subtitle": "从 issue 追到出错代码，生成可直接应用的 diff 和回归测试。",
        "hero_step1_label": "01",
        "hero_step1_title": "粘贴 Issue 链接",
        "hero_step1_desc": "公开仓库即可，零配置",
        "hero_step2_label": "02",
        "hero_step2_title": "自动排查",
        "hero_step2_desc": "沿调用链读源码，追到出错位置",
        "hero_step3_label": "03",
        "hero_step3_title": "查看报告",
        "hero_step3_desc": "根因、diff、回归测试，直接可用",
        "hero_examples_title": "真实案例",
        "hero_examples_desc": "选一条直接排查",
        ...
        "matrix_pass": "通过",
        "matrix_fail": "未通过",
        "coverage_chart_title": "调查覆盖分析",
        "coverage_chart_caption": (
            "对照已读文件与报告引用：绿色=已读且转化为证据，灰色=已读未引用，红色=引用但从未读取（幻觉风险）"
        ),
        "coverage_read_supported": "已读取并转化为证据",
        "coverage_read_unused": "已读取但未引用",
        "coverage_not_read": "引用但从未读取",
        "coverage_phantom_hint": "该文件被报告引用为证据，但调查过程从未读取过它，请人工核实",
        "coverage_evidence_count": "证据条数",
        "coverage_others": "+{n} 个其他文件",
        "coverage_stat": "覆盖率：{used}/{total} 个已读文件转化为证据（{pct}%）",
        "coverage_empty": "暂无覆盖数据",
        "timeline_chart_title": "调查阶段耗时",
        "timeline_chart_caption": "基于事件日志真实时间戳统计各阶段耗时，橙色为耗时最长的阶段",
        "timeline_tools": "{n} 次工具调用",
        "timeline_total": "总耗时：{duration}",
        "timeline_fallback_note": "无阶段时间数据 · 显示调查活动量",
        "timeline_metric_model_calls": "模型调用",
        "timeline_metric_tool_calls": "工具调用",
        "timeline_metric_files_read": "文件读取",
        "timeline_metric_evidence": "证据条数",
        "timeline_empty": "暂无调查过程数据",
        ...
        "matrix_detail_review_revised": "审查后已修订并通过",
    ...
    "en": {
        ...
        "hero_title": "No more digging through source",
        "hero_title_accent": "get a patch that runs",
        "hero_subtitle": (
            "It traces the issue to the failing code, "
            "then returns a ready-to-apply diff with regression tests."
        ),
        "hero_step1_label": "01",
        "hero_step1_title": "Paste an issue link",
        "hero_step1_desc": "Public repos, zero setup",
        "hero_step2_label": "02",
        "hero_step2_title": "Automated triage",
        "hero_step2_desc": "Follows the call path to the failing code",
        "hero_step3_label": "03",
        "hero_step3_title": "Read the report",
        "hero_step3_desc": "Root cause, diff, regression tests",
        "hero_examples_title": "Real cases",
        "hero_examples_desc": "Pick one to run",
        "hero_example_1_repo": "psf/requests",
        ...
        "matrix_chart_caption": "Four-dimension check: file read · lines · reason · review",
        ...
        "coverage_chart_caption": (
            "Which files that were read became evidence — red bars flag citations of files never read"
        ),
